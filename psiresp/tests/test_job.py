...
class TestMultiRespFast:
    ...
    def test_run_with_empty(self, empty_client):
        ...
        methylammonium_charges = [-0.159693, -0.204556,  0.133935,  0.133935,
                                  0.133935,  0.31824, 0.318735,  0.32547]
        nme2ala2_charges = [-0.561372, 0.644321, -0.388168, -0.577036, 0.429494,
                            -0.579042, -0.623843, 0.362648, -0.290239, -0.402024,
