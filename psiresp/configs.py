...
class TwoStageRESP(ConfiguredJob):
    ...
    _configuration: ClassVar[dict] = dict(
        ...
        resp_options=dict(restraint_scale_stage_1=0.0005,
                          restraint_scale_stage_2=0.001,
                          restraint_steepness=0.1,
                          stage_2=True,
...
class OneStageRESP(ConfiguredJob):
    ...
    _configuration = dict(qm_options=dict(method="hf",
                          ...
                          grid_options=dict(use_radii="msk"),
                          resp_options=dict(restraint_scale_stage_1=0.01,
                                            restraint_scale_stage_2=0.0,
                                            restraint_steepness=0.1,
                                            stage_2=False,
                                            exclude_hydrogens=True,
                                            restrained_fit=True),
...
class ESP(ConfiguredJob):
    ...
    _configuration = dict(qm_options=dict(method="hf",
                          ...
                          grid_options=dict(use_radii="msk"),
                          resp_options=dict(restraint_scale_stage_1=0.0,
                                            restraint_scale_stage_2=0.0,
                                            restraint_steepness=0.1,
                                            stage_2=False,
                                            exclude_hydrogens=True,
