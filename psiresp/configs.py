...
def resp_config(
    ...
    def wrapper(cls):
        ...
        def optimize_geometry(self, psi4_options={}, save_opt_geometry=False, **kwargs):
            ...
            """
            return super(cls, self).optimize_geometry(
                method=method,
                basis=basis,
                psi4_options=psi4_options,
                save_opt_geometry=save_opt_geometry,
        ...
        def iter_solve(self, q, a, b, hyp_a=0.0005, tol=1e-6, maxiter=50, **kwargs):
            ...
            return super(cls, self).iter_solve(
                q,
                a,
                b,
                hyp_a=hyp_a,
        ...
        def get_constraint_matrices(
            ...
            **kwargs
            ...
            b: ndarray
            """
            return super(cls, self).get_constraint_matrices(
                method=method,
                basis=basis,
                chrconstr=chrconstr,
                chrequiv=chrequiv,
        ...
        cls.fit = fit
        cls.iter_solve = iter_solve
        cls.get_constraint_matrices = get_constraint_matrices
        return cls
    ...
    def wrapper(cls):
        ...
        def optimize_geometry(self, psi4_options={}, save_opt_geometry=False):
            ...
            save_opt_geometry: bool (optional)
                if ``True``, saves optimised geometries to XYZ file
            """
            super(cls, self).optimize_geometry(
                method=method,
                basis=basis,
                psi4_options=psi4_options,
                save_opt_geometry=save_opt_geometry,
        ...
        def get_constraint_matrices(
            ...
            **kwargs
            ...
            super(cls, self).get_constraint_matrices(
                intra_chrconstr=intra_chrconstr,
                intra_chrequiv=intra_chrequiv,
                inter_chrconstr=inter_chrconstr,
                inter_chrequiv=inter_chrequiv,
